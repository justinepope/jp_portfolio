...
<head>
  ...
  <title>Justine Pope | UX/UI Designer | Front-end Developer</title>
  ...
  <script src="https://use.fontawesome.com/9ac78dd706.js"></script>
	
</head>
<body>
  <nav class="white" role="navigation">
    <div class="nav-wrapper container">
      <a id="logo-container" href="#" class="brand-logo right">justine pope</a>
      ...
      <div class="container">
        <br><br>
			...
			<div class="row button">
			  	<a href="#contact" id="download-button" class="btn-large waves-effect waves-light col l2 offset-l7 z-depth-5 hide-on-small-only">Contact Me</a>
			</div>
		  </div>
		<div class="row">
